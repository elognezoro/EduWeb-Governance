...
export default async function NewUserPage() {
  ...
  const [roles, organizations, structures, countries, ministries] = await Promise.all([
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardContent className="p-6">
          <UserForm roles={roles} organizations={organizations} structures={structures} countries={countries} ministries={ministries} />
        </CardContent>
      </Card>
    </div>
  );
